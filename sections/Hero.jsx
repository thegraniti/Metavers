...
const Hero = () => (
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`} >
    ...
    <motion.div variants={slideIn('right', 'tween', 0.2, 1)} className="relative w-full md:-mt-[40px] -mt-[12px]">
<div className="absolute w-full h-[300px] her-gradient rounded-tl-[140px] 1-[0] -top-[30px]"/>
